...
export function installOfficeMock(seed: OfficeSeed): void {
  ...
  const documentStateKey = "__accelerate_word_e2e_document_v1";
  const officeStorageKey = "__accelerate_word_e2e_office_storage_v1";
  const accessTokenKey = "mike_token";
  const refreshTokenKey = "mike_refresh_token";
  const editApplyModeKey = "accelerate_word_edit_apply_mode";
  const chatStorageModePrefix = "accelerate_word_chat_storage_mode:";
