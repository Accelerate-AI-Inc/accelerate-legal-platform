/**
 * Shared Playwright fixture for the Accelerate Legal Word add-in E2E suite.
 *
...
export interface Addin {
  ...
  /** Mock any Accelerate Legal API endpoint returning JSON for the given METHOD + URL glob. */
  mockApiJson(
    method: HttpMethod,
    urlGlob: string,
    json: unknown,
  ...
  /** Mock any Accelerate Legal API endpoint returning an error status for METHOD + URL glob. */
  mockApiError(
    method: HttpMethod,
    urlGlob: string,
    status: number,
