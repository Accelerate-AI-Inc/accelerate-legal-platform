 ...
 * frontend/src/app/lib/accelerateApi.ts, with auth state synchronized by
 * ../auth/session.
 *
 ...
 * configureAccelerateApiClient() below before the first request leaves.
 */
import { configureAccelerateApiClient } from "./client";
