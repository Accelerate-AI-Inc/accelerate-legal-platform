...
import { PillButtonUI as PillButton } from "@ax/pill-button-ui";
import { GoogleIconUI } from "@ax/google-icon-ui";
import { AuthDividerUI as AuthDivider } from "@ax/auth-divider-ui";
import {
  authCardUIClassName,
  authInputUIClassName,
} from "@ax/auth-styles-ui";
...
export function LoginPage(): React.ReactElement {
  ...
  return (
    <div className="h-full overflow-y-auto bg-paper/80">
      <main className="relative flex min-h-full items-center justify-center px-6 py-10">
        ...
        <div data-testid="login-panel" className="w-full max-w-md">
          <div
            ...
            className={`${authCardUIClassName} mb-4`}
          >
            <h1 className="mb-6 text-left font-serif text-2xl font-medium text-ink">
              Log In
            </h1>
            ...
            >
              ...
              {error && (
                <div
                  className="rounded bg-critical-wash p-3 text-sm text-critical"
                  role="alert"
                >
                  {error}
                </div>
