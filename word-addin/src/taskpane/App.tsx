...
export default function App(): React.ReactElement {
  ...
  if (!wordDocument.documentId) {
    return (
      <div className="flex h-full items-center justify-center p-6 text-center text-sm text-critical">
  ...
  return (
    <div className="relative h-full overflow-hidden bg-background">
      ...
      <div className="absolute inset-x-3 top-14 z-30">
        {error && (
          <div
            className="mb-2 rounded-sm bg-critical-wash px-3 py-2 text-sm text-critical"
            role="alert"
          >
            {error}
          </div>
