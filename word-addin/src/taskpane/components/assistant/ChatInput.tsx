      ...
      <>
        ...
        >
          ...
          {composerError && (
            <div
              role="alert"
              className="mb-2 flex items-center justify-between gap-2 rounded-sm border border-critical bg-critical-wash/95 px-3 py-2 text-xs text-ink"
            >
              ...
              <button
                ...
                className="shrink-0 rounded p-0.5 text-ink-faint hover:bg-ink/5 hover:text-ink"
              >
            ...
            <ChatInputShell
              ...
              attachments={
                selectedWorkflow || attachedDocuments.length > 0 ? (
                  <>
                    {selectedWorkflow && (
                      <div className="inline-flex items-center gap-1 rounded-full border border-rule/20 bg-accent py-0.5 pl-2.5 pr-1 text-xs text-paper shadow">
                        ...
                        <button
                          ...
                          className="ml-0.5 rounded-full p-0.5 text-paper/60 transition-colors hover:bg-surface/20 hover:text-paper"
                        >
                    ...
                    {attachedDocuments.map((document) => (
                      <div
                        key={document.id}
                        className="inline-flex items-center gap-1 rounded-[10px] border border-rule/70 bg-surface py-0.5 pl-2 pr-1 text-xs text-ink"
                      >
                        <FileTypeIcon
