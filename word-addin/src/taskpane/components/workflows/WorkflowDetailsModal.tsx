...
import { WorkflowSlashCommandUI } from "@ax/workflow-slash-command-ui";
import type { Workflow } from "../../types";
import { deleteWorkflow, updateWorkflow } from "../../api/accelerateApi";
...
export function WorkflowDetailsModal({
  ...
  return (
    <>
      ...
      >
        <div className="pb-5 text-sm leading-6 text-ink-muted">
          <p>
            {workflow.is_default
