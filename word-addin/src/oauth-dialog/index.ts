...
const REQUEST_STORAGE_KEY = "accelerate-word-google-oauth-request";
...
function clearTemporaryAuthStorage(): void {
  ...
  for (const storage of [window.sessionStorage, window.localStorage]) {
    storage.removeItem("accelerate-word-google-oauth");
    storage.removeItem("accelerate-word-google-oauth-code-verifier");
  }
