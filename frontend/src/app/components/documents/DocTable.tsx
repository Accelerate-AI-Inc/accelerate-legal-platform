...
import { LibraryIcon } from "@/app/components/shared/AppSidebarIcons";
...
function ProjectTableLoadingHeader({ stickyCellBg }: { stickyCellBg: string }) {
    return (
        <TableHeaderRow className={`${stickyCellBg} pr-3`}>
            ...
            >
                <div className="mr-3 h-2.5 w-2.5 rounded bg-surface-sunk animate-pulse" />
                ...
                <div key={i} className="flex h-10 min-w-max items-center pr-3">
                    <div className={`sticky left-0 z-[60] ${DOC_NAME_COL_W} ${stickyCellBg} py-2 pl-3 pr-2`}>
                        <div className="flex min-w-0 items-center">
                            <div className="mr-3 h-2.5 w-2.5 shrink-0 rounded bg-surface-sunk animate-pulse" />
                            <div className="mr-2 h-4 w-4 shrink-0 rounded bg-surface-sunk animate-pulse" />
                            <div
                                className="h-3.5 min-w-0 flex-1 rounded bg-surface-sunk animate-pulse"
                                style={{ maxWidth: `${160 + i * 20}px` }}
                            />
                        </div>
                    </div>
                    <div className="ml-auto w-20 shrink-0">
                        <div className="h-3 w-8 rounded bg-surface-sunk animate-pulse" />
                    </div>
                    <div className="w-24 shrink-0">
                        <div className="h-3 w-12 rounded bg-surface-sunk animate-pulse" />
                    </div>
                    <div className="w-20 shrink-0">
                        <div className="h-3 w-5 rounded bg-surface-sunk animate-pulse" />
                    </div>
                    <div className="w-32 shrink-0">
                        <div className="h-3 w-16 rounded bg-surface-sunk animate-pulse" />
                    </div>
                    <div className="w-32 shrink-0">
                        <div className="h-3 w-16 rounded bg-surface-sunk animate-pulse" />
                    </div>
...
export function DocTable({
    ...
    function hasMovePayload(dt: DataTransfer): boolean {
        return Array.from(dt.types).some(
            (type) =>
                ...
                type === "application/accelerate-folder",
        );
    }
    ...
    async function handleDropOnFolder(targetFolderId: string | null, dt: DataTransfer) {
        ...
        const subFolderId = dt.getData("application/accelerate-folder");
        if (docIds.length > 0) {
            ...
            >
                ...
                >
                    <div className="flex items-center">
                        ...
                        <input
                            autoFocus
                            className="flex-1 min-w-0 text-xs text-ink bg-transparent outline-none border-b border-rule-strong"
    ...
    function renderDocumentActivityRow({
        ...
        return (
            <div key={key} className="group flex h-10 min-w-max items-center pr-3">
                ...
                >
                    <div className="flex items-center">
                        <Loader2 className="mr-3 h-2.5 w-2.5 animate-spin text-ink-faint shrink-0" />
                        {entryKind === "folder" && (
                            <span className="mr-2 flex h-4 w-4 shrink-0 items-center justify-center">
                                <ChevronRight className="h-4 w-4 text-ink-faint" />
                            </span>
                ...
                <div className="ml-auto w-20 shrink-0 text-xs text-ink-faint lowercase truncate">
                    {entryKind === "folder"
                        ? "folder"
                        : fileType ??
                          (filename.includes(".")
                ...
                <div className="w-24 shrink-0 text-xs text-ink-faint">{statusLabel}</div>
                <div className="w-20 shrink-0 text-xs text-ink-faint">—</div>
                <div className="w-32 shrink-0 text-xs text-ink-faint">—</div>
                <div className="w-32 shrink-0 text-xs text-ink-faint">—</div>
                <div className="w-8 shrink-0" />
            </div>
        );
                    ...
                    return (
                        ...
                        >
                            <div
                                ...
                                className={`group flex h-10 min-w-max items-center pr-3 cursor-pointer transition-colors ${isVersionDragOver ? "bg-accent-wash ring-1 ring-inset ring-accent" : isSelected ? SURFACE_SELECTED_CLASS : SURFACE_HOVER_CLASS}`}
                            >
                                {(() => {
                                    ...
                                    return (
                                        <>
                                            <div
                                                className={`sticky left-0 z-[60] ${DOC_NAME_COL_W} ${rowBg} py-2 pl-3 pr-2 transition-colors ${isVersionDragOver || isSelected ? "" : SURFACE_GROUP_HOVER_CLASS}`}
                                                style={treeNameCellStyle(depth)}
                                            >
                                                <div className="flex items-center">
                                                    {isProcessing || isUploadingVersion ? (
                                                        ...
                                                        <input
                                                            ...
                                                            className="mr-3 h-2.5 w-2.5 shrink-0 rounded border-rule cursor-pointer accent-ink"
                                                        />
                                                    )}
                                                    <span className="mr-2 shrink-0">
                                                        {isError ? (
                                                    ...
                                                    {renamingDocumentId === doc.id ? (
                                                        <input
                                                            autoFocus
                                                            className="min-w-0 flex-1 text-xs text-ink bg-transparent outline-none border-b border-rule-strong"
                                            ...
                                            <div className="ml-auto w-20 shrink-0 text-xs text-ink-muted lowercase truncate">
                                                {doc.file_type ?? <span className="text-ink-faint">—</span>}
                                            </div>
                                            <div className="w-24 shrink-0 text-xs text-ink-muted truncate">
                                                {doc.size_bytes != null ? (
                                            ...
                                            <div
                                                className="w-20 shrink-0 text-xs text-ink-muted flex items-center gap-1"
                                                onClick={(e) => e.stopPropagation()}
                                            >
                                                {hasVersions ? (
                                                    <button
                                                        onClick={() => void toggleVersions(doc.id)}
                                                        className={`flex items-center gap-1 rounded px-1 py-0.5 transition-colors ${SURFACE_HOVER_CLASS}`}
                                                    >
                                                    ...
                                                    <span className="text-ink-faint pl-1">—</span>
                                                )}
                                            </div>
                                            <div className="w-32 shrink-0 text-xs text-ink-muted truncate">
                                                {doc.created_at ? (
                        ...
                        >
                            <div
                                ...
                                onDragStart={(e) => {
                                    ...
                                    e.dataTransfer.setData("application/accelerate-folder", folder.id);
                                ...
                                className={`group flex h-10 min-w-max items-center pr-3 ${SURFACE_HOVER_CLASS} cursor-pointer transition-colors ${isRenaming ? "" : "select-none"} ${dragOverFolderId === folder.id ? "bg-accent-wash ring-1 ring-inset ring-accent" : ""}`}
                            >
                                <div
                                    className={`sticky left-0 z-[60] ${DOC_NAME_COL_W} py-2 pl-3 pr-2 ${dragOverFolderId === folder.id ? "bg-accent-wash" : stickyCellBg} transition-colors ${dragOverFolderId === folder.id ? "" : SURFACE_GROUP_HOVER_CLASS}`}
                                    style={treeNameCellStyle(depth)}
                                >
                                    <div className="flex items-center">
                                        <input
                                        ...
                                        {isRenaming ? (
                                            <input
                                                autoFocus
                                                className="flex-1 min-w-0 text-xs text-ink bg-transparent outline-none"
                                            ...
                                            <span className="text-xs text-ink truncate">{folder.name}</span>
                                        )}
                                    </div>
                                </div>
                                <div className="ml-auto w-20 shrink-0 text-xs text-ink-faint">—</div>
                                <div className="w-24 shrink-0 text-xs text-ink-faint">—</div>
                                <div className="w-20 shrink-0 text-xs text-ink-faint">—</div>
                                <div className="w-32 shrink-0 truncate text-xs text-ink-muted">
    ...
    const pendingVersionDropMessage = pendingVersionDrop ? (
        <div className="space-y-2">
            <p>
                ...
                <span className="font-medium text-ink">{pendingVersionDrop.sourceDoc.filename}</span> as a new
                version of <span className="font-medium text-ink">{pendingVersionDrop.targetDoc.filename}</span>.
            </p>
            <p>
                <span className="font-medium text-ink">{pendingVersionDrop.sourceDoc.filename}</span> will no
    ...
    const pendingDeleteDocMessage = pendingDeleteDoc ? (
        <div className="space-y-2">
            <p>
                <span className="font-medium text-ink">{pendingDeleteDoc.filename}</span> has{" "}
    ...
    const pendingDeleteFolderMessage = pendingDeleteFolder ? (
        <div className="space-y-2">
            <p>
                ...
                , including <span className="font-medium text-ink">{pendingDeleteFolder.folder.name}</span>
                    ...
                    <div className="flex-1 flex flex-col min-h-0">
                        ...
                        >
                            {dragOverRoot && dragOverFolderId === null && (
                                <div className="absolute inset-0 border-2 border-accent pointer-events-none z-[80]" />
                            )}
                            {dragOverFileRoot && (
                            ...
                            !hasVisibleCollectionUpload ? (
                                serverQueryActive ? (
                                    <div className="flex-1 flex flex-col items-center justify-center py-24 text-center">
                                        <p className="text-sm text-ink-faint">No matches found</p>
                                    </div>
                                ) : (
                                    <div
                                            ...
                                            {filteredDocs.map((doc) => {
                                                ...
                                                return (
                                                    <div key={doc.id}>
                                                        ...
                                                        >
                                                            <div
                                                                className={`sticky left-0 z-[60] ${DOC_NAME_COL_W} ${isVersionDragOver ? "bg-accent-wash" : isSelected ? SURFACE_SELECTED_CLASS : stickyCellBg} py-2 pl-3 pr-2 transition-colors ${isVersionDragOver || isSelected ? "" : SURFACE_GROUP_HOVER_CLASS}`}
                                                            >
                                                                <div className="flex items-center">
                                                                    {isProcessing || isUploadingVersion ? (
                                                                        <Loader2 className="mr-3 h-2.5 w-2.5 animate-spin text-ink-faint shrink-0" />
