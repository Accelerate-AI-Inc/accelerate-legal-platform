    ...
    return (
        ...
        >
            <div className="min-h-0 flex-1 space-y-5 overflow-y-auto pb-2 pt-0">
                <p className="text-sm text-ink-muted pb-6">{message}</p>
                {loading ? (
                    ...
                    <div className="space-y-4">
                        {factors.length > 1 && (
                            <select
                                ...
                                className="h-9 w-full rounded-sm bg-surface-sunk px-3 text-sm text-ink outline-none focus-visible:ring-2 focus-visible:ring-rule-strong/45"
                            >
                                {factors.map((factor) => (
        ...
        >
            {digits.map((digit, index) => (
                <input
                    ...
                    className="h-13 w-12 rounded-sm border border-rule-strong bg-paper text-center text-2xl font-medium font-serif text-ink shadow-none outline-none transition-colors focus:border-rule-strong focus:ring-2 focus:ring-rule-strong/45 disabled:cursor-not-allowed disabled:opacity-45"
