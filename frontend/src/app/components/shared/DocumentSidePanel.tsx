...
import type { DocumentVersion } from "@/app/lib/accelerateApi";
import { cn } from "@/app/lib/utils";
import {
    SIDE_PANEL_SURFACE_CLASS,
    SURFACE_PANEL_CLASS,
    SURFACE_HOVER_CLASS,
    SURFACE_INSET_CLASS,
    ...
    return createPortal(
        ...
        >
            <div
                ...
                className="absolute inset-y-0 left-0 z-20 hidden w-1 cursor-col-resize bg-transparent transition-colors hover:bg-accent/60 md:block"
            ...
            <div className="mx-3 flex min-h-11 shrink-0 items-center justify-between gap-3 py-2 md:h-11 md:py-0">
                ...
                <div className="flex shrink-0 items-center gap-1.5">
                    <div className="flex h-7 items-center rounded-full bg-surface-sunk/70 p-0.5 md:hidden">
                        <button
                            type="button"
                ...
                >
                    <div className="mb-4 shrink-0">
                        ...
                        {editingName ? (
                            <div className="space-y-1.5">
                                <div className="flex min-h-6 items-center gap-2">
                                    <input
                                        ...
                                        className="h-6 min-w-0 flex-1 border-0 border-b border-rule-strong bg-transparent px-0 text-xs leading-6 text-ink outline-none transition-colors focus:border-rule-strong"
                                        autoFocus
                                    />
                                    <button
                                        type="button"
                                        ...
                                        disabled={savingName}
                                        className="inline-flex h-6 w-6 shrink-0 items-center justify-center rounded-sm text-ink-muted transition-colors hover:bg-surface/65 hover:text-ink disabled:cursor-not-allowed disabled:opacity-40"
                                        title="Save name"
                                    >
                                        {savingName ? (
                            ...
                            <div className="flex min-h-6 items-center gap-2">
                                <div className="min-w-0 flex-1 truncate text-xs leading-6 text-ink">
                                    {selectedFilename}
                                </div>
                                {selectedVersionId && (
                                    <button
                                        ...
                                        className="inline-flex h-6 w-6 shrink-0 items-center justify-center rounded-sm text-ink-muted transition-colors hover:bg-surface/65 hover:text-ink"
                                        title="Edit name"
                                    >
                    ...
                    <div className="mb-3 shrink-0 text-xs font-medium text-ink">
                        Document Data
                    </div>
                    <div className="shrink-0 rounded-sm py-2">
                        <div className="space-y-1.5">
                            <DataRow
                                label="Type"
                    ...
                    <div className="mb-2 mt-4 shrink-0 text-xs font-medium text-ink">
                        Versions
                    </div>
                                    ...
                                    {orderedVersions.map((version) => {
                                        ...
                                        return (
                                            <div
                                                ...
                                                className={cn(
                                                    `group relative flex w-full flex-col overflow-hidden rounded-sm px-3 py-2 ${SURFACE_PANEL_CLASS} ${SURFACE_HOVER_CLASS} transition-all`,
                                                    deleted
                                            ...
                                            >
                                                <div className="flex min-w-0 items-center gap-1.5">
                                                    ...
                                                    <div
                                                        className={cn(
                                                            "min-w-0 flex-1 truncate text-xs font-medium text-ink",
                                                        )}
                                                    >
                                                        {filename}
                                                    </div>
                                                ...
                                                <div className="flex min-w-0 items-center gap-2">
                                                    <div className="min-w-0 flex-1 truncate text-[11px] text-ink-faint">
                                                        {version.created_at
                                                            ? new Date(
                                                                  version.created_at,
                                                              ).toLocaleString()
                                                        ...
                                                        {deleted ? (
                                                            ...
                                                            <>
                                                                <button
                                                                    ...
                                                                    className="inline-flex h-5 w-5 items-center justify-center rounded-full text-accent transition-colors hover:bg-accent-wash hover:text-accent-hover disabled:cursor-not-allowed disabled:opacity-40"
                                                                ...
                                                                <button
                                                                    ...
                                                                    className="inline-flex h-5 w-5 items-center justify-center rounded-full text-ink-muted transition-colors hover:bg-surface-sunk hover:text-ink"
                                                                ...
                                                                <button
                                                                    ...
                                                                    className={cn(
                                                                        "inline-flex h-5 w-5 items-center justify-center rounded-full text-critical transition-colors hover:bg-critical-wash hover:text-critical disabled:cursor-not-allowed disabled:opacity-40",
                                                                        !canDelete &&
                                                                            "cursor-not-allowed opacity-40 hover:bg-transparent hover:text-critical",
                                                                    )}
                    ...
                    {uploadError && (
                        <div className="mx-4 mb-2 flex items-center gap-2 rounded-sm bg-critical-wash px-3 py-2 text-xs text-ink">
                            <AlertCircle className="h-3.5 w-3.5 shrink-0 text-critical" />
...
function VersionUploadSkeleton() {
    return (
        <div className={`rounded-sm px-3 py-2 ${SURFACE_PANEL_CLASS}`}>
            <div className="animate-pulse space-y-2">
                <div className="flex items-center justify-between gap-3">
                    <div className="flex min-w-0 flex-1 items-center gap-1.5">
                        <div className="h-3 w-3 shrink-0 rounded bg-surface-sunk" />
                        <div className="h-3 w-3/5 rounded-full bg-surface-sunk" />
                    </div>
                    <div className="flex shrink-0 items-center gap-1">
                        <div className="h-3 w-3 rounded bg-surface-sunk" />
                        <div className="h-[11px] w-12 rounded-full bg-surface-sunk" />
                    </div>
                </div>
                <div className="h-2.5 w-2/5 rounded-full bg-surface-sunk" />
            </div>
        </div>
    );
}
