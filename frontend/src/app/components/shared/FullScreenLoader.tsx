...
export function FullScreenLoader() {
    return (
        <div className="flex min-h-dvh items-center justify-center bg-paper/80">
            <div className="h-6 w-6 animate-spin rounded-full border-2 border-rule border-t-gray-700" />
        </div>
    );
}
