...
export function ToggleSwitch({
    ...
    return (
        <button
            ...
            className={cn(
                "flex w-fit items-center gap-2.5 text-sm text-ink-muted outline-none disabled:cursor-default disabled:opacity-40",
        ...
        >
            ...
            >
                <span
                    ...
                    className={cn(
                        "absolute left-1 top-1 h-3 w-3 rounded-full bg-surface transition-transform duration-200",
