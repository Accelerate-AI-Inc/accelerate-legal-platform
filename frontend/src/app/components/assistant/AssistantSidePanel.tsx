...
import { SURFACE_PANEL_CLASS } from "@/app/components/ui/surface";
import { LegalSourceIcon } from "@/app/components/shared/LegalSourceIcon";
    ...
    return (
        ...
        >
            ...
            >
                    ...
                    {tabs.map((tab) => {
                        ...
                        return (
                            <div
                                ...
                                className={cn(
                                    "document-tab group relative flex items-center gap-1.5 pl-3 pr-1.5 h-8 min-w-0 max-w-[220px] rounded-t-sm cursor-pointer select-none transition-colors",
                                    isActive ? "z-20" : "z-10",
                            ...
                            >
                                        ...
                                        <span
                                            className={`inline-flex shrink-0 items-center rounded border px-1 py-px text-[9px] font-medium ${
                                                isActive
                                                    ...
                                                    : "border-rule-strong bg-surface/70 text-ink-muted"
                                            }`}
                                        >
                                ...
                                <button
                                    ...
                                    className="shrink-0 rounded-full p-0.5 text-ink-faint hover:text-ink"
                                >
                                    <X className="h-3 w-3" />
                                </button>
                            </div>
                ...
                <button
                    onClick={onCloseAll}
                    className="shrink-0 mb-1 ml-1 rounded-sm p-1.5 text-ink-faint hover:text-ink"
                    title="Close panel"
                >
                    <X className="h-4 w-4" />
                </button>
