...
interface Props {
    ...
    isStreaming?: boolean;
    isError?: boolean;
    /** Human-readable error text rendered alongside the red Accelerate Legal icon. */
    errorMessage?: string;
    citations?: Citation[];
        ...
        <div style={{ minHeight }}>
            ...
            <div className="w-full font-inter relative mt-2">
                ...
                {topLevelErrorMessage && (
                    <p className="mt-2 text-base font-serif leading-7 text-critical">
                        {topLevelErrorMessage}
                    </p>
                )}
                ...
                <div className="flex items-center gap-2 py-2 font-sans justify-start">
                    {!isStreaming && (
                        <button
                            ...
                            className="p-1.5 rounded text-ink-muted hover:text-ink hover:bg-surface-sunk"
                            onClick={handleCopy}
                        >
                            {isCopied ? (
