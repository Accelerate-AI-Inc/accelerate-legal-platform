                ...
                >
                    ...
                    {(selectedWorkflow || attachedDocs.length > 0) && (
                        <div className="flex flex-wrap gap-1.5 px-2 pt-2">
                            {selectedWorkflow && (
                                <div className="inline-flex items-center gap-1 pl-2.5 pr-1 py-0.5 rounded-full text-xs bg-accent text-paper border border-rule/20 shadow">
                                    ...
                                    <button
                                        ...
                                        className="rounded-full p-0.5 ml-0.5 text-paper/60 hover:text-paper hover:bg-surface/20 transition-colors"
                                    >
                            ...
                            {attachedDocs.map((doc) => {
                                ...
                                return (
                                    <div
                                        key={doc.id}
                                        className={`inline-flex items-center rounded-[10px] text-xs text-ink ${SURFACE_PANEL_CLASS}`}
                                    >
                                        {onDocumentClick ? (
                                            <button
                                                type="button"
                                                ...
                                                className="inline-flex min-w-0 items-center gap-1 py-0.5 pl-2 transition-colors hover:text-ink"
                                            >
                                                {documentLabel}
                                            </button>
                                        ) : (
                                        ...
                                        <button
                                            ...
                                            className="mx-1 rounded-full p-0.5 text-ink-faint transition-colors hover:bg-ink/5 hover:text-ink"
                                        >
                                            <X className="h-2.5 w-2.5" />
                                        </button>
                                    </div>
                    ...
                    {uploadingFilenames.length > 0 && (
                        <div className="flex flex-wrap items-center gap-1.5 px-2 pt-2">
                            {uploadingFilenames.map((filename, index) => (
                                <div
                                    key={`${filename}-${index}`}
                                    className={`inline-flex items-center gap-1 rounded-[10px] px-2 py-1 text-xs text-ink-muted ${SURFACE_PANEL_CLASS}`}
                                >
                    ...
                    <div className="px-4 pt-4">
                        <textarea
                            ...
                            className="w-full resize-none text-sm overflow-hidden border-0 text-base p-0 bg-transparent outline-none placeholder:text-ink-faint leading-6 max-h-48"
                        />
                    </div>
                    ...
                    >
                        <div className="flex items-center gap-1">
                            ...
                            {!hideWorkflowButton && (
                                <button
                                    ...
                                    className={cn(
                                        "flex items-center gap-1.5 rounded-sm px-2 h-8 text-sm transition-colors",
                                        selectedWorkflow
                        ...
                        <div className="flex items-center gap-1">
                            ...
                            <button
                                ...
                                className={cn(
                                    "relative bg-ink text-paper rounded-sm h-8 w-8 flex items-center justify-center cursor-pointer disabled:cursor-default disabled:bg-ink-faint border-0 active:enabled:scale-95 transition-all duration-150",
                                    "",
                                )}
