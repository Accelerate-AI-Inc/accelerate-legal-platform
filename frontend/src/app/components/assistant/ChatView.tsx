...
import { SURFACE_VEIL_ACTION_CLASS } from "@/app/components/ui/surface";
                        ...
                        {!messagesVisible && (
                            <div className="space-y-6 md:space-y-8 w-full">
                                <div className="flex justify-end">
                                    <div className="bg-surface-sunk rounded-sm p-4 w-2/5">
                ...
                {showScrollButton && (
                    ...
                    >
                        <button
                            ...
                            className={`cursor-pointer rounded-full p-2 transition-all ${SURFACE_VEIL_ACTION_CLASS}`}
                        >
                ...
                <div className="absolute bottom-3 left-0 right-0 w-full z-30">
                    <div className="pointer-events-none absolute -bottom-3 left-0 right-0 z-0">
                        <div className="mx-auto h-7 w-full max-w-4xl px-4 md:px-6">
                            <div className="h-full rounded-t-[20px] bg-paper" />
                        </div>
                    </div>
                    <div
