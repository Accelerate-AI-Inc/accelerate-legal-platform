...
export function MarkdownContent({
    ...
    return (
        <div
            ref={divRef}
            className="text-ink mb-4 text-base prose prose-sm max-w-none font-serif"
        >
            <ReactMarkdown
                remarkPlugins={[
                ...
                components={{
                    table: (props) => (
                        <div className="overflow-x-auto my-4 rounded-sm">
                            <table
                                className="min-w-full divide-y divide-rule-strong overflow-hidden"
                    ...
                    td: (props) => (
                        <td
                            className="whitespace-normal px-3 py-4 text-sm text-ink"
                            {...withoutMarkdownNode(props)}
                        />
                    ),
                    h1: (props) => (
                    ...
                    code: (props) => {
                        ...
                        return (
                            <code
                                className="bg-surface-sunk px-1.5 py-0.5 rounded text-sm font-serif"
                                {...codeProps}
                            >
                                {children}
                            </code>
                    ...
                    blockquote: (props) => (
                        <blockquote
                            className="border-l-4 border-rule-strong pl-4 italic my-4"
                            {...withoutMarkdownNode(props)}
                        />
                    ),
                    a: (props) => {
