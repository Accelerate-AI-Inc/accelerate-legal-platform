...
import { RESPONSE_SURFACE_CLASS } from "./messageStyles";
...
export function CitationsBlock({
    ...
    return (
        <div className="mt-2 mb-3">
            <div className={`overflow-hidden ${RESPONSE_SURFACE_CLASS}`}>
                <div className="flex items-center justify-between gap-3 bg-surface/25 px-3 py-2">
                        ...
                        return (
                            ...
                            >
                                <button
                                    ...
                                    className="flex min-w-0 flex-1 items-center gap-2 rounded-sm text-left text-sm font-serif text-ink transition-colors enabled:hover:text-ink disabled:cursor-default"
                                >
                                    <CitationSourceIcon
