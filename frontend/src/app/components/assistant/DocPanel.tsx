    ...
    return (
        <div className="px-3 py-2">
            <div className="flex items-start gap-3">
                <div className="flex min-w-0 flex-1 items-start gap-2">
                    ...
                    <div className="flex min-w-0 flex-1 flex-wrap items-center gap-2">
                        <h2
                            className="min-w-0 break-words text-sm font-medium text-ink"
                            title={document.title}
                        >
                            {document.title}
                        </h2>
                        {versionNumber && versionNumber > 0 ? (
                            <span className="inline-flex shrink-0 items-center rounded-sm border border-rule bg-surface px-1.5 py-0.5 text-[10px] font-medium text-ink-muted">
                                V{versionNumber}
                            </span>
                        ) : null}
                    </div>
            ...
            {document.metadata.length > 0 && (
                <div className="mt-1 flex w-full flex-wrap items-center gap-x-3 gap-y-1 font-serif text-sm text-ink-muted">
