        ...
        >
            <div className="flex min-h-0 flex-1 flex-col gap-4 overflow-y-auto">
                ...
                {col.tags && col.tags.length > 0 && (
                    <div>
                        ...
                        <div className="flex flex-wrap gap-1.5">
                            {col.tags.map((tag) => (
                                <span key={tag} className="inline-block rounded-full bg-surface-sunk px-2 py-0.5 text-xs text-ink-muted">{tag}</span>
                            ))}
                        </div>
                    </div>
                )}
                <div>
                    ...
                    <div className="text-base text-ink leading-relaxed font-serif prose prose-base max-w-none">
