...
import type { UserLookupResult } from "@/app/lib/accelerateApi";
...
import { OVERLAY_ROW_HOVER_CLASS } from "@/shared/ui/SurfaceUI";
                                ...
                                <ul className="space-y-1 pt-1">
                                    {sharedUsers.map((entry) => {
                                        ...
                                        return (
                                            <li
                                                key={entry.email}
                                                className={`${OVERLAY_ROW_HOVER_CLASS} flex items-center gap-2.5 rounded-sm px-2 py-1.5 transition-colors`}
                                            >
                                                ...
                                                <button
                                                    ...
                                                    className="self-center inline-flex items-center rounded-full px-2 py-1 text-xs text-ink-muted transition-colors hover:text-critical"
