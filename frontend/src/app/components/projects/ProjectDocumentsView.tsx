        ...
        <div className="flex items-center gap-1.5">
            ...
            {selectionActions && (
                <div ref={actionsRef} className="relative">
                    ...
                    {actionsOpen && (
                        <div className={`absolute right-0 top-full z-[120] mt-1 w-36 overflow-hidden rounded-sm ${SURFACE_OVERLAY_CLASS}`}>
                            <button
                                onClick={() => {
                                    setActionsOpen(false);
                                    void selectionActions.onDownload();
                                }}
                                className={`w-full px-3 py-1.5 text-left text-xs text-ink-muted transition-colors ${SURFACE_HOVER_CLASS}`}
                            >
                                Download
                            </button>
                            ...
                            <button
                                ...
                                className="w-full px-3 py-1.5 text-left text-xs text-critical transition-colors hover:bg-critical-wash"
                            >
                                Delete
                            </button>
                        </div>
    ...
    if (!projectLoading && !project) {
        return (
            <div className="flex h-full items-center justify-center">
                <p className="text-ink-faint">Project not found</p>
            </div>
        );
    }
