    ...
    return (
        <div className="px-4 py-5">
            ...
            >
                            ...
                            {visibleCatalog.map((model, index) => {
                                ...
                                return (
                                    <MenuButton
                                        ...
                                        className={`flex w-full items-center gap-2 rounded-sm px-3 py-1.5 text-left ${active ? "bg-surface-sunk text-ink" : ""}`}
                                    >
                                        ...
                                        {selected && (
                                            <Check className="h-3.5 w-3.5 shrink-0 text-ink-muted" />
                                        )}
                                    </MenuButton>
                                );
                            })}
                ...
                <div
                    className={`flex h-9 min-w-0 flex-1 items-center px-0 focus-within:border-rule focus-within:ring-2 focus-within:ring-rule-strong/45 ${SETTINGS_CONTROL_CLASS}`}
                >
                    <input
                        ref={inputRef}
                        type="text"
                        ...
                        className="h-full min-w-0 flex-1 bg-transparent text-sm text-ink outline-none placeholder:text-ink-faint disabled:cursor-not-allowed"
                        onChange={(event) => {
                    ...
                    <button
                        ...
                        className="flex h-full shrink-0 items-center justify-end text-ink-faint transition-colors hover:text-ink disabled:cursor-default disabled:opacity-40"
                    >
                        <ChevronDown
                ...
                <div className="mt-3 flex flex-wrap gap-1.5">
                    {selection.map((model) => (
                        ...
                        >
                            ...
                            <X className="h-3 w-3 shrink-0 text-ink-faint" />
                        </OptionPill>
                    ))}
                </div>
            )}
