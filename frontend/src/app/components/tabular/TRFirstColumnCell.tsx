        ...
        <div ref={containerRef} className={`${className} relative`}>
            ...
            {row.row_type === "folder" ? (
                ...
                <button
                    ...
                    className="flex min-w-0 flex-1 items-center rounded-sm text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/50 disabled:cursor-default"
                >
                    <FileTypeIcon
                        fileType={row.label}
            ...
            {row.row_type === "folder" && expanded && (
                <TRExpandedCellSurface>
                    <div className="p-2 text-xs text-ink">
                        ...
                        <div className="max-h-64 overflow-y-auto">
                            {sourceDocuments.map((document) => (
                                <button
                                    ...
                                    className="flex min-h-7 w-full items-center rounded-sm py-1 text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/50"
                                    aria-label={`Open ${document.filename}`}
                                >
                                    <CornerDownRight
                                        className="mr-2 h-3.5 w-3.5 shrink-0 text-ink-faint"
                                        aria-hidden="true"
                                    />
                                    <FileTypeIcon
                                        fileType={
