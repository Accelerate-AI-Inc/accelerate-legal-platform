...
import { deleteAccount, isMfaRequiredError } from "@/app/lib/accelerateApi";
    ...
    return (
        <div className="space-y-8">
                    ...
                    <div className="space-y-8 p-4">
                        <div>
                            <div className="flex items-start justify-between gap-3">
                                ...
                                <span
                                    className={`text-xs ${nameError ? "text-critical" : "text-ink-faint"}`}
                                    aria-live="polite"
                                >
                                    {isSavingName
                                        ? "Saving..."
                        ...
                        <div>
                            <div className="flex items-start justify-between gap-3">
                                ...
                                <span
                                    className={`text-xs ${orgError ? "text-critical" : "text-ink-faint"}`}
                                    aria-live="polite"
                                >
                                    {isSavingOrg
                                        ? "Saving..."
                    ...
                    <div className="space-y-2 p-4">
                        ...
                        <div className="flex justify-end">
                            <button
                                ...
                                className="text-xs font-medium text-ink transition-colors hover:text-ink disabled:cursor-not-allowed disabled:text-ink-faint"
                            >
                                {requiresPasswordForEmailChange
                                    ? "Update"
                                    : isSavingEmail
            ...
            <section className="space-y-3">
                ...
                <SettingsSection>
                    <div className="p-4">
                        <p className="text-base font-medium text-ink-muted capitalize">
                            {profile?.tier || "Free"}
                        </p>
                    </div>
                </SettingsSection>
            ...
            {/* Danger Zone */}
            <section className="space-y-3">
                <h2 className="text-2xl font-medium font-serif text-critical">
                    Danger Zone
                </h2>
                <SettingsSection>
