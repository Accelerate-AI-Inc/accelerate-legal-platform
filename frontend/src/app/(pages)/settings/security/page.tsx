...
import { isMfaRequiredError } from "@/app/lib/accelerateApi";
        ...
        >
            {digits.map((digit, index) => (
                <input
                    ...
                    className="h-11 w-10 rounded-sm border border-transparent bg-surface-sunk text-center text-lg font-medium text-ink shadow-none outline-none transition-colors focus:border-rule focus:ring-2 focus:ring-rule-strong/45 disabled:cursor-not-allowed disabled:opacity-45"
    ...
    return (
        <div className="flex items-center justify-between gap-3 px-4 py-5">
            <div className="min-w-0 flex-1 space-y-1">
                <div>
                    <div className="h-4 w-36 animate-pulse rounded bg-surface-sunk" />
                </div>
                <div className="space-y-1.5 pt-1">
                    <div className="h-3 w-full max-w-md animate-pulse rounded bg-surface-sunk" />
                    <div className="h-3 w-3/4 max-w-sm animate-pulse rounded bg-surface-sunk" />
                </div>
            </div>
            <div className="h-9 w-20 shrink-0 animate-pulse rounded-sm bg-surface-sunk" />
        </div>
    );
}
    ...
    return (
        <div className="space-y-8">
            <section className="space-y-3">
                <h2 className="text-2xl font-medium font-serif text-ink">
                                ...
                                <>
                                    ...
                                    <div className="flex justify-end px-4 pb-4 pt-1">
                                        <button
                                            ...
                                            className="text-xs font-medium text-critical transition-colors hover:text-critical disabled:cursor-not-allowed disabled:text-critical"
                                        >
                    ...
                    {!enrollment ? (
                        ...
                        <>
                            ...
                            <div className="flex justify-center">
                                <div className="flex h-48 w-48 items-center justify-center rounded-sm bg-surface p-2">
                                    <img
