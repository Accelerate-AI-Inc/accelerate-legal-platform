...
export default function PrivacyDataPage() {
    ...
    const handleExportAccountData = async () => {
        ...
        try {
            ...
            downloadBlob(blob, filename ?? "accelerate-account-export.json");
        } catch (error) {
    ...
    const handleExportChatData = async () => {
        ...
        try {
            ...
            downloadBlob(blob, filename ?? "accelerate-chat-export.json");
        } catch (error) {
    ...
    const handleExportTabularReviewsData = async () => {
        ...
        try {
            ...
            downloadBlob(blob, filename ?? "accelerate-tabular-reviews-export.json");
        } catch (error) {
