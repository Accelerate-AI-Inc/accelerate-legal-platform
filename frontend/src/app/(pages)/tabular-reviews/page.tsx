    ...
    const toolbarActions =
        selectedIds.length > 0 ? (
            <div ref={actionsRef} className="relative">
                ...
                {actionsOpen && (
                    <MenuSurface className="absolute top-full right-0 mt-1 z-[100] w-36 overflow-hidden">
                        <button
        ...
        <div className="flex h-full min-h-0 flex-1 flex-col overflow-hidden">
            ...
            >
                {effectiveLoading ? (
                    ...
                    <TableEmptyState>
                        <p className="text-lg font-medium font-serif text-ink">
                    ...
                    <TableEmptyState>
                        ...
                        !debouncedSearch ? (
                            <>
                                <ReviewsIcon className="mb-4 h-8 w-8" />
                                <p className="text-2xl font-medium font-serif text-ink">
                                    Tabular Reviews
                                </p>
                                <p className="mt-1 text-xs text-ink-faint max-w-xs text-left">
                            ...
                            return (
                                ...
                                >
                                    <TablePrimaryCell
                                        ...
                                        selectionIndicator={
                                            deleting ? (
                                                <Loader2 className="mr-4 h-3 w-3 shrink-0 animate-spin text-ink-faint" />
                                            ) : undefined
                                        }
                                        onSelectionChange={() =>
                                            toggleOne(review.id)
