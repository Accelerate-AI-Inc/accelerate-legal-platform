...
import { deleteTabularReview, updateTabularReview } from "@/app/lib/accelerateApi";
...
function SelectedReviewActions({
    ...
    return (
        <div className="relative">
            ...
            {open && (
                <div className="absolute right-0 top-full z-[120] mt-1 w-36 overflow-hidden rounded-sm border border-rule/60 bg-surface">
                    <button
                        onClick={onDelete}
