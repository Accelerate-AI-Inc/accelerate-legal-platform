...
function SignupContent() {
    ...
    return (
        <div className="relative flex min-h-dvh items-center justify-center bg-paper/80 px-6 py-24">
            <div className="absolute top-4 md:top-8 left-1/2 -translate-x-1/2">
                <SiteLogo size="lg" asLink />
            </div>
            <div className="w-full max-w-md">
                <div className={cn(authGlassCardClassName, "mb-4")}>
                    <h2 className="mb-6 text-left text-2xl font-medium font-serif text-ink">
                        Sign Up
                    </h2>
                    ...
                    <form onSubmit={handleSignup} className="space-y-4">
                        ...
                        <div className="space-y-3 pt-2">
                            <div className="text-center text-xs text-ink-muted">
                                ...
                                <Link
                                    href="https://accelerateai.io/terms"
                                    target="_blank"
                                ...
                                and{" "}
                                <Link
                                    href="https://accelerateai.io/privacy"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="text-accent hover:underline"
                                >
