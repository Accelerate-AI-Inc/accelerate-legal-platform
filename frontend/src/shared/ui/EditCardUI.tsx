        ...
        >
            {(changeNumber !== undefined || reason) && (
                <div className="mb-2 flex items-start gap-2">
                    ...
                    {reason && (
                        <p className="min-w-0 flex-1 font-serif text-sm text-ink-muted">
                            {reason}
                        </p>
                    )}
                </div>
            ...
            {(hasEditText || previewContent !== undefined) && (
                <div className="rounded-sm bg-surface-sunk/70 px-2 py-2 font-sans text-xs leading-relaxed">
            ...
            {locationHint && (
                <p
                    className="mt-1 truncate font-sans text-[11px] text-ink-faint"
                    title={locationHint}
                >
                    In: “{locationHint}”
                </p>
