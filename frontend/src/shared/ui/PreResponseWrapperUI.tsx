    ...
    return (
        <CardUI>
            <button
                ...
                className={`flex w-full items-center justify-between px-3 font-serif text-sm text-ink-muted transition-colors hover:text-ink ${isOpen ? "pt-2" : "py-2"}`}
            >
                <span className="flex min-w-0 items-baseline">
                    ...
                    {isStreaming && (
                        <span
                            ...
                            aria-hidden="true"
                        >
                            <span className="mr-0.5 h-0.5 w-0.5 rounded-full bg-rule-strong animate-[bounce_1.4s_infinite_0s]" />
                            <span className="mr-0.5 h-0.5 w-0.5 rounded-full bg-rule-strong animate-[bounce_1.4s_infinite_0.2s]" />
                            <span className="h-0.5 w-0.5 rounded-full bg-rule-strong animate-[bounce_1.4s_infinite_0.4s]" />
                        </span>
                    )}
                </span>
                <ChevronDown
