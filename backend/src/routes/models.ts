...
// tool calling because Accelerate Legal supplies tools on interactive chat requests.
...
// calling because Accelerate Legal supplies tools on interactive chat requests. A key must
...
// lib/llm/models instead of offering Responses models Accelerate Legal cannot yet use.
