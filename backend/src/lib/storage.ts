/**
 * Cloudflare R2 storage utilities for Accelerate Legal document management.
...
/**
 * Fresh installs get the current default. Existing deployments already set
 * R2_BUCKET_NAME explicitly and must keep doing so — changing the bucket would
 * orphan every stored object. See docs/deployment.md.
 */
const BUCKET = process.env.R2_BUCKET_NAME ?? "accelerate";
